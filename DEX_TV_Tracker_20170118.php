...
##      * fix episode ID's to always be SxxxExxx, epsecially or shows that use years instead of seasons!
##      * Fix ADD NEW SHOW in the navbar
...
<?php
    ...
    $VERS = "v0.05";
    $FILE = "DEX_TV_Tracker.dex";      #!# Fix this to allow multiple copies on same server by using php name!
?>
