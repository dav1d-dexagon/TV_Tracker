...
##   Ep_Number      $SHOWS[$i][1] = "S01x08"        |   [FILE] Episode Number of last watched show
...
##
##   Ep_Next        $SHOWS[$i][7] = "S01x09"        |   Episode number for NEXT episodes. Use this 
...
##     Episode  a string of the format S99x88 where "S" is a capital S, "99" is the season, 
##              "x" is a lower-case "X", and "88" is the episodes within that season. eg. S03x06
...
##
##  Items still left to be completed are marked with #!#
##
...
<?php
    ...
    $VERS = "v0.04";
    $FILE = "DEX_TV_Tracker.dex";      #!# Allow multiple copies on same server by using php name!
?>
...
<table cellpadding='0' cellspacing='0' border='1' width='999px'>
  <tr>
    ...
    <td align='top'>
        ...
        &nbsp;&nbsp;&nbsp;
        <a href='javascript:void(0);' onClick='pinnerOn();addTVMID();' title='Add this new TVMID to your tracker list. Click here to submit. Must be numeric.'>Add TVMID:</a><input id='TVMID_input' size='7' maxlength='7'>
        &nbsp;
        <br>
        <center>
...
?>
    ...
    <!-- scripts that have to be loaded near the botoom of the document   -->
...
#        echo "<br>Episodes:" . $E_total ;
        ...
        for ( $ptr=$E_total-1; $ptr>=0; $ptr-- ) {
            ...
            $E_SSSEEE = "S" . sprintf("%02d",$json->{"_embedded"}->{"episodes"}[$ptr]->{"season"}) . "x" . sprintf("%02d",$json->{"_embedded"}->{"episodes"}[$ptr]->{"number"}) ;
...
/* * * * * * * * * * * * * * * * * */
    function putShows(){
        ...
        fwrite($myfile, "# This is the data file for DEX_TV_Tracker.php\n");
        fwrite($myfile, "# DO NOT MODIFY THIS FILE unless you understand the consequences!\n");
        fwrite($myfile, "# This file was written on " . gmstrftime("%Y-%m-%d %H:%M:%S_UTC", time()) . "\n");
