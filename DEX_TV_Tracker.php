...
##      * use the JSON file format instead of the existing "proprietary format"
...
##
    ...
    # Initialization: get the filename so we can determine the name of the data file
...
<?php
    ...
    $NameVersTime = $NAME . " " . $VERS . "<br>" . $localtime . "" ; 
?>
...
;
        ...
        $myfile = fopen($FILE_name. "_" . $USERUUID . ".json", "w") or die("Unable to open file!");
